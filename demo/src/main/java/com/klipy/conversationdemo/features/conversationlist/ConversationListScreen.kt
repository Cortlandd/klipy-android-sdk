...
import com.klipy.conversationdemo.ui.theme.KlipyTheme

@Composable
fun ConversationListScreen(
    state: ConversationListState,
    reducer: ConversationListReducer
) {
    ...
    Scaffold(
        ...
        Conversations(
            ...
            onConversationClick = { reducer.postAction(ConversationListAction.ConversationClicked(it.toString())) }
        )
    }
}
